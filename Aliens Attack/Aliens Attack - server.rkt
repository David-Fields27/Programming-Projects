...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname AvaAttacksv8) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect
 ...
 (make-bundle (make-univ (list iworld1 iworld2)
                         (make-world
                          ...
                          (list (make-posn 1 2))))
  (list
   (make-mail iworld1 (list
                       'world
                       (list (list 7 "iworld1") (list 8 "iworld2"))
                       (list (list 3 3))
                       'right
                       (list (list 1 2))))
   (make-mail iworld2 (list
                       'world
                       (list (list 7 "iworld1") (list 8 "iworld2"))
                       (list (list 3 3))
                       'right
...
(check-expect
 ...
 (make-bundle
  (make-univ (list iworld1 iworld2) (make-world
